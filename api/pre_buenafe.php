...
switch ($opcion) {
    case 0:
        ...
        if ($user['acceso'] != 'administrador') {
            ...
            WHERE (patinadores.cuit=$cuit OR prebuenafe.cuitalta=$cuit) AND estadotorneo = 'Abierto'";
        } else {
    ...
    case 2:
        ...
        if (isset($_POST['libroTorneo'])) {
            ...
            $sql = "UPDATE prebuenafe SET divisional='$divisional', eficiencia='$eficiencia', categoria = '$categoria', disciplina = '$disciplina', torneo = '$torneo', observaciones = '$observaciones', apagar = '$apagar', pagado = '$pagado', estado='$estado', dnimod = '$dnimod', nombremod = '$nombremod', apellidomod = '$apellidomod', cuitmod = '$cuitmod', institucionmod = '$institucionmod', fechamod = '$fechamod' WHERE prebuenafe.id = $id;";
        }
    ...
    case 13:
        // MUEVE LOS DATOS DEL PREBUENAFE EN LA TABLA BUENAFE
        $id = $_GET['id'];
        ...
        if (mysqli_query($conexion, $sql)) {
            ...
            $sql = "INSERT INTO ctacte (cuit, tipo_comprobante, fecha_alta, concepto, adeudado, pagado, dnipatinador, tipolicencia,dnialta, apellidoalta, nombrealta, cuitalta, institucionalta, fechaalta) SELECT cuitalta, 'Ticket', fechaalta, torneo, apagar, '0', dnibuenafe, disciplina, dnialta, apellidoalta, nombrealta, cuitalta, institucionalta, fechaalta FROM prebuenafe WHERE prebuenafe.id = $id";
            if (mysqli_query($conexion, $sql)) {
