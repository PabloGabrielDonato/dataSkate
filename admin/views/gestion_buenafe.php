        ...
        <div class="modal-content">
          ...
          <div class="col-lg-12 modal-body">
                  ...
                  <div class="accordion-body">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6 form-floating formEstado">
                        <select name="estado" class="form-control form-control-edit" id="consultarEstado" required>
                          <option value=""></option>
            ...
            <div class="ocultarInputOpcion">
              ...
              <input name="apagar" type="number" value="0" />
      ...
      var listar = function() {
        ...
        table = $("#tablaClientes").DataTable({
          ...
          columnDefs: [{
              ...
              targets: [5, 6, 7, 8, 9, 10, 13, 14, 15],
            },
            {
              searchPanes: {
                show: false,
              },
              targets: [1, 2, 3, 11, 12, 16],
            },
